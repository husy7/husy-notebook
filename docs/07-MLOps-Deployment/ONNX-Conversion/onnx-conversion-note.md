---
title: "[ONNX 转换：笔记标题]"
description: "[ONNX 转换方向——SEO 一句话描述]"
tags: [MLOps, ONNX]
date: YYYY-MM-DD
authors: [YourName]
---
...
> **🚀 核心目标**：读完这篇笔记，我能用自己的话把 [ONNX 转换核心概念] 讲给一个完全不懂技术的朋友听，并且能随手写出核心代码。
...
- 依赖前置知识：[[07-MLOps-Deployment/FastAPI-Serving/xxx.md]]（FastAPI 服务化）
- 进阶方向：[[07-MLOps-Deployment/Triton-Server/xxx.md]]（Triton 推理服务）
