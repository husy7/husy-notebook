...
> **🚀 核心目标**：读完这篇笔记，我能用自己的话把 [文本预处理核心概念] 讲给一个完全不懂技术的朋友听，并且能随手写出核心代码。
...
- 依赖前置知识：[[04-NLP-LLM/Seq2Seq-Attention/xxx.md]]（Seq2Seq 与注意力）
- 进阶方向：[[04-NLP-LLM/Word-Embedding/xxx.md]]（词嵌入）
