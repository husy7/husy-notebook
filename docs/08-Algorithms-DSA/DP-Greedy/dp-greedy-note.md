---
title: "[动态规划与贪心：笔记标题]"
description: "[动态规划与贪心方向——SEO 一句话描述]"
tags: [算法, DP]
date: YYYY-MM-DD
authors: [YourName]
---
...
> **🚀 核心目标**：读完这篇笔记，我能用自己的话把 [动态规划与贪心核心概念] 讲给一个完全不懂技术的朋友听，并且能随手写出核心代码。
...
- 依赖前置知识：[[08-Algorithms-DSA/Sorting/xxx.md]]（排序算法）
- 进阶方向：[[08-Algorithms-DSA/Graph/xxx.md]]（图算法）
