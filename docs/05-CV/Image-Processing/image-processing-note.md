...
> **🚀 核心目标**：读完这篇笔记，我能用自己的话把 [图像处理核心概念] 讲给一个完全不懂技术的朋友听，并且能随手写出核心代码。
...
- 依赖前置知识：[[05-CV/CNN-Architectures/xxx.md]]（CNN 架构）
- 进阶方向：[[05-CV/Object-Detection/xxx.md]]（目标检测）
