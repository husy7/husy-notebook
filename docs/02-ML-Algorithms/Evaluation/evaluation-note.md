...
> **🚀 核心目标**：读完这篇笔记，我能用自己的话把 [模型评估核心概念] 讲给一个完全不懂技术的朋友听，并且能随手写出核心代码。
...
- 依赖前置知识：[[02-ML-Algorithms/Clustering/xxx.md]]（聚类）
- 进阶方向：[[02-ML-Algorithms/Linear-Models/xxx.md]]（线性模型）
