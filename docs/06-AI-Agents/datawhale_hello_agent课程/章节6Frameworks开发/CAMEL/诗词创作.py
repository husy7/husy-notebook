...
# 初始化角色扮演会话
# AI {} "user"，负责提出写作结构和要求
# AI {} "assistant"，负责提供专业知识和内容
role_play_session = RolePlaying(
    assistant_role_name="风水师",
    user_role_name="诗人",
    task_prompt=task_prompt,
    with_task_specify=True,          # 开启，让AI细化任务
...
while n < chat_turn_limit:
    ...
    print_text_animated(Fore.BLUE + f"诗人:\n\n{user_response.msg.content}\n")
    print_text_animated(Fore.GREEN + f"风水师:\n\n{assistant_response.msg.content}\n")

    # 检查任务完成标志
    if "CAMEL_TASK_DONE" in user_response.msg.content:
        print(Fore.MAGENTA + "创作完成！")
        break
