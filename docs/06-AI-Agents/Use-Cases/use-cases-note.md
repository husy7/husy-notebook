...
> **🚀 核心目标**：读完这篇笔记，我能用自己的话把 [应用用例核心概念] 讲给一个完全不懂技术的朋友听，并且能随手写出核心代码。
...
- 依赖前置知识：[[06-AI-Agents/RAG/xxx.md]]（RAG 检索增强生成）
- 进阶方向：[[06-AI-Agents/Agent-Architecture/xxx.md]]（Agent 架构）
